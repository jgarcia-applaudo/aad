...
Read the project configuration (`CLAUDE.md` or `.github/copilot-instructions.md`) to learn the project's stack and structure.
...
3. **Load relevant skills**: If domain skills or instructions apply to the task, read them to understand the project's patterns.
