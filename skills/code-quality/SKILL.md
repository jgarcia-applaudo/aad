...
1. **Run project tools**: Execute the lint and type-check commands defined in the project configuration. If not defined, try to detect them from the project's configuration files.
...
3. **Verify against skills**: If domain skills or instructions exist, use them as reference to validate project patterns.
